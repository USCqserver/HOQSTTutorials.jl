...
We can also directly plot the spectral density of Ohmic bath:
...
Because we want to compare our results to the [[1]](https://journals.aps.org/pra/abstract/10.1103/PhysRevA.91.062320), we need to set the unit to $\hbar=1$.
...
```
0.004622 seconds (2.42 k allocations: 147.051 KiB)
```
...
```
0.013090 seconds (193.16 k allocations: 4.270 MiB)
```
...
```
0.133059 seconds (1.37 M allocations: 70.515 MiB, 17.40% gc time)
```
